...
11. http://localhost:8081/users -> only admin can access  this and can create users like USER and ADMIN -> POST method. You need to put body like username, password and role in the body section of the request.
12. Above 3 endpoints /user, /admin, and, /users need Basic authentication as authentication type in postman.
